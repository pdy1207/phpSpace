    ...
    <table class=middle>
        <thead>
            <tr align=center>
                ...
                <th width=80><a href='javascript:revcheck(this.form)'>전체 선택</a></th>
            </tr>
        </thead>
        <?php
    ...
    while($row = $result->fetch_array()){
        ...
        <tbody>
            <tr align=center>
                ...
                <td><?php if ($row['biz_phonecorp'] == 'KTF'){$phonecorp = 'KT';} else { $phonecorp = $row['biz_phonecorp'];} echo $phonecorp;?>
                </td>
                ...
                <td><input type="checkbox" name="url_num" value="<?=$list_row['no']?>"></td>
            </tr>
        </tbody>
